...
## 🚀 About Me
- 소프트웨어 개발, 백엔드 시스템, 실용적인 문제 해결에 관심이 있습니다
- 개인 프로젝트와 학교 프로젝트를 통해 배우고 있습니다
- 직접 만들고 문서화하는 과정을 통해 한 단계씩 성장하고 있습니다

## 📚 Current Focus
- 실용적인 백엔드 및 시스템 관련 프로젝트 만들기
- CS 기초와 개발 기본기 다지기
- 프로젝트 구조, 문서화, 문제 해결 능력 향상하기
